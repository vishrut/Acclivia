...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Project Manager - Acclivia</title>
 ...
 <!--Le typeahead starts-->
  ...
  <body>
	...
	{?>
	  ...
	  {
		  $lname = mysql_real_escape_string($_POST['livefilename']);
      ...
      <div class="span12">
		...
		<hr>
         ...
         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
         	           ...
         	           <!--a href="#" role="button" class="btn btn-small btn-info">Timeline</a-->
         <p></p>
        <p><?php echo $Gdesc ?></p>
         <hr>         
          <form class="form-inline" style="margin-left:-100px">
              ...
              <a href="#leavegroup" role="button" class="btn btn-small btn-info" data-toggle="modal"><img src="assets/img/to_do.png">&nbsp;&nbsp;Leave Group</a>
          ...
          <div id="addgroupmember" class="modal hide fade" aria-hidden="true">
            ...
            <div id="leavegroup" class="modal hide fade" aria-hidden="true">
              <div class="modal-header">
                 <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                 <h3>Leave Group</h3>
              </div>
          ...
          <p><a href="#membermodal" id="tooltip_members" data-toggle="modal" title="Group Members"><?php echo sizeof($arr9) ; ?> Members</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#tasks" id="tooltip_tasks" data-toggle="tooltip" title="Group Tasks"><?php echo sizeof($arr1); ?> Tasks</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#upfiles" id="tooltip_files" data-toggle="tooltip" title="Group Files"><?php echo sizeof($arr2); ?> Files</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <!--a href="#livedocs" id="tooltip_live" data-toggle="tooltip" title="Live Docs for Concurrent Editing"><?php /*echo sizeof($arr14); */?> Live Files</a-->
            <hr>
		...
		{	
		  ...
		  else
		  {
            ...
            <label class="checkbox inline">
                <a href="#unfinished"><?php echo $tname; ?></a>
              </label>
              <label class="checkbox inline">
    ...
    <button class="btn btn-success" name="save1" onClick="document.location.reload(true)">Done</button>
          ...
          <!-- ////////////////////////////////////////////////////////////////////////////////////////////////-->          
			...
			{	
				...
				{
					$fname = $row15['filename'];
					$upl_date = $row15['create_date'];
      ...
      */?>
          ...
          <!--Le meeting start-->
              ...
              <!--form class="form-inline">
              <label>
              <h4><a id="livedocs" style="color:inherit;">Meetings</a></h4>
              </label>
              </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              ...
              <!--Le add new meeting modal-->
                <!--div id="meetingmodal" class="modal hide fade" aria-hidden="true">
                  ...
                  <div class="modal-body">
                    ...
                    <input style="margin-left:45%;" class="btn btn-success" type="submit" name="add_meeting1" value="save changes" />
                    </form>&nbsp;&nbsp;
                  </div>
                </div-->
          <?php
