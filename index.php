...
if(isset($_POST['signup'])){
	...
	if (empty ($error)){
			...
			if (mysql_num_rows($result)==0){
				...
				$result2 = mysql_query("INSERT INTO temp_login (user_id,name,primary_email,password,activation,gender) VALUES('','$name','$email','$password','$activation','$gendr') ") or die (mysql_error());
					if(!$result2){
